MENU_STRUCTURE = {
    'cms': {
        'admin': [
            ...
            {"name": "Complaints", "url_name": "cms:incharge_complaints_history", "icon": "fa fa-exclamation-circle"},
        ...
        'user': [
            ...
            {"name": "Complaints", "url_name": "cms:staff_complaints_history", "icon": "fa fa-exclamation-circle"},
    ...
    'tms': {
        'admin': [
            ...
            {"name": "Tasks", "url_name": "tms:tasks", "view_name":"AllTasks", "icon": "fa fa-exclamation-circle"},
        ...
        'user': [
            ...
            {"name": "My Tasks", "url_name": "tms:my_tasks", "view_name":"MyTasks", "icon": "fa fa-exclamation-circle"},
