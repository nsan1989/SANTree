...
urlpatterns = [
    ...
    path(
        "super_admin_dashboard/all_departments/", DepartmentView, name="all_departments"
    ),
    path(
        "super_admin_dashboard/all_departments/<int:id>/department_detail/",
        DepartmentDetails,
        name="department_detail",
    ),
    path(
        "super_admin_dashboard/all_departments/<int:id>/department_detail/department_complaint/",
        DepartmentComplaints,
        name="department_complaints",
    ),
    path(
        "super_admin_dashboard/all_departments/<int:id>/department_detail/department_task/",
        DepartmentTasks,
    ...
    path(
        "dept_complaint_pie_chart/<int:id>/",
        DeptComplaintPieChart,
        name="dept_complaint_pie_chart",
    ),
    path("dept_task_pie_chart/<int:id>/", DeptTaskPieChart, name="dept_task_pie_chart"),
    path(
        "all_complaints_pie_chart/",
        AllComplaintPieChart,
        name="all_complaints_pie_chart",
    ),
    ...
    path(
        "super_admin_dashboard/all_complaints/<int:id>/complaint_detail/",
        ComplaintDetailView,
        name="complaint_detail",
    ),
    path("super_admin_dashboard/all_tasks/", TaskView, name="all_tasks"),
    path(
        "super_admin_dashboard/all_tasks/<int:id>/task_detail/",
        TaskDetailView,
        name="task_detail",
    ),
    path("super_admin_dashboard/all_services/", ServiceView, name="all_services"),
    path(
        "super_admin_dashboard/all_services/<int:id>/service_detail/",
        ServiceDetailView,
        name="service_detail",
    ),
    ...
    path(
        ...
        AnonymousServiceView,
        name="anonymous_service_generate",
    ),
    path(
        "anonymous_service_generate/success_page/",
        ServiceSuccessView,
        name="success_page",
    ),
