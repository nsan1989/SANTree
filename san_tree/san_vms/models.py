...
class Vehicle(models.Model):
    ...
    def current_location(self):
        ...
        last_completed = self.bookings.filter(
            status="COMPLETED"
        ).order_by("-created_at").first()
...
class Booking(models.Model):
    ...
    priority = models.CharField(max_length=20, choices=BookingPriority.choices, default=BookingPriority.NORMAL)
    department_priority = models.IntegerField(default=0, help_text="Higher value = higher priority department")
    ...
    recurrence_pattern = models.CharField(max_length=50, blank=True, help_text="Example: DAILY, WEEKLY_MON, WEEKLY_FRI")
