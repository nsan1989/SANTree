...
urlpatterns = [
    ...
    path('admin/all_cab_requests/', AdminCabRequestsView, name='vms_admin_cab_requests'),
    path('admin/all_trips/', AdminTripsView, name='vms_admin_trips'),
    path('admin/all_cab_requests/update_booking_status/<int:booking_id>/', AdminUpdateBookingStatusView, name='update_booking_status'),
