...
urlpatterns = [
    ...
    path(
        "tasks_admin/all_tasks/all_tasks_details/<int:id>/",
        AllTasksDetails,
        name="admin_tasks_details",
    ),
    path(
        "tasks_admin/all_tasks/all_tasks_details/update_status/<int:id>/",
        UpdateStatus,
