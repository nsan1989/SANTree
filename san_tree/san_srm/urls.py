...
urlpatterns = [
    ...
    path(
        "incharge/dashboard/request_service/", ServiceView, name="admin_request_service"
    ),
    path("incharge/dashboard/schedules/", ShiftSchedules, name="schedule"),
    path(
        "incharge/dashboard/schedules/set_schedule/",
        ShiftScheduleView,
        name="shift_schedule",
    ),
    path(
    ...
    path(
        ...
        AllGeneratedService,
        name="all_generate_service",
    ),
    path(
        "staff/dashboard/service/<int:id>/update_status/",
        free_up_completed_staff,
        name="staff_update_service_status",
    ),
