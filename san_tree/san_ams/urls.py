...
urlpatterns = [
    ...
    path('admin/assets/asset_requests/', AssetRequestView, name='admin_asset_requests'),
    ...
    path('staff/assets/asset_requests/', AssetRequestView, name='staff_asset_requests'),
