...
urlpatterns = [
    ...
    path(
        "admin/add_accessory_category/",
        AddAccessoryCategoryView,
        name="add_accessory_category",
    ),
    path("admin/add_accessory/", AddAccessoryView, name="add_accessory"),
    path(
        "admin/add_consumable_category/",
        AddConsumableCategoryView,
        name="add_consumable_category",
    ),
    path("admin/add_consumable/", AddConsumableView, name="add_consumable"),
    path(
        "admin/add_component_category/",
        AddComponentCategoryView,
        name="add_component_category",
    ),
    ...
    path(
        "admin/assets/asset_detail/<int:asset_id>/",
        AssetDetailView,
    ...
    path(
        "staff/assets/asset_detail/<int:asset_id>/",
        AssetDetailView,
        name="staff_asset_detail",
    ),
    path("admin/licenses/", LicenseView, name="all_licenses"),
    path(
        "admin/licenses/assign_license/", AssignedLicensesView, name="assigned_license"
    ),
    path(
        "admin/licenses/license_detail/<int:license_id>/",
        LicenseDetailView,
        name="license_detail",
    ),
